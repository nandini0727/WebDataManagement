...
text="Please enter atleast 5 charecters";
error_message_login.innerHTML=text;
return false;
}
...
var rpsw =document.getElementById("password_confirmation").value;
...
if(user.length<5){
text="Please enter valid user name with more than 5 characters";
error_message.innerHTML=text;
return false;
}
if(psw.length<5){
text="Please enter valid password with more than 5 characters";
error_message.innerHTML=text;
return false;
}
if (psw != rpsw) {
    ...
    <div class="wrapper1">
      <div class="navBar">
        ...
        <li><a href="/homes" class="listelem"> HOME</a></li>
                    ...
                    <li><a href="#" id="navbar12" class="listelem"> LOG IN </a></li>
                    <li><a href="#" id="navbar13"  class="listelem active"> SIGN UP </a></li>
         <li>
            <footer>
...
<div id="error_message" style="color:red;"></div>
  ...
  <form action="/register" id="signup_form" class="form-container"  method="post" onsubmit="return validation_signup()">
  {{ csrf_field() }}
...
@endif
  ...
  <p class="login_text">check in<i class="fas fa-times" id="form_close"></i></p>
    <hr>
     ...
     <input style="left:0px;" type="text" id="name" name="name" required>
   ...
   <div class="signup_form"><p class="textbox_text"><b>Email:</b></p></div>
    <input type="text" id="emails" name="email" required>
...
<i><strong><div id="error_message_login" style="color:red; background-color:black;"></div></strong></i>
  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="login-form" class="form-container" onsubmit="return validation()" method="post">

    <p class="login_text">Log-in <i class="fas fa-times" id="form_close_login" style="margin-left:85%;"></i></p>
    <hr>

    <p class="user"><b>User:</p>
    <input type="text"id="username_login" name="user" required>
    
    <p class="user">Password:</p>
    <input type="password" id="psw_login" name="psw" required>
  <hr>
  

    <button type="submit" class="btn1_login" style="margin-left:20%;">Close</button>
