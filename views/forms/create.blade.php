...
<label><input type="checkbox" value="coindesk" name="option[]">Coin
...
<div class="checkbox">
<label><input type="checkbox" value="coinbase" name="option[]">Coi
...
<label><input type="checkbox" value="zebpay" name="option[]">Zebpay
...
<button type="submit" class="btn btn-success" style="margin-left:38px">Su
